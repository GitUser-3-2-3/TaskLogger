...
ALTER TABLE tasks
    ADD CONSTRAINT future_deadline CHECK (deadline > created_at);
...
ALTER TABLE tasks
    ADD CONSTRAINT tasks_category_id_fkey FOREIGN KEY (category_id) REFERENCES categories (ctg_id) ON DELETE CASCADE;
